...
class ContactService {
    companion object {
        // Définitions des données des différents contacts des responsables de l'association Cartel.
        val CONTACTS: List<ContactDto> = listOf(
            ...
            ContactDto(8, "Responsabe Restauration", "Problème de restauration","Cassiopée André", "07 78 35 97 56"),
